...
namespace AppGestionEMS.Controllers
{
    ...
    public class AsignacionDocentesController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.GrupoclasesId = new SelectList(db.GrupoClases, "Id", "Nombre");
        ...
        public ActionResult Create([Bind(Include = "Id,NumCreditos,CursoId,UserId,GrupoclasesId")] AsignacionDocentes asignacionDocentes)
        {
            ...
            ViewBag.GrupoclasesId = new SelectList(db.GrupoClases, "Id", "Nombre", asignacionDocentes.GrupoclasesId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NumCreditos,CursoId,UserId,GrupoclasesId")] AsignacionDocentes asignacionDocentes)
        {
            if (ModelState.IsValid)
            {
